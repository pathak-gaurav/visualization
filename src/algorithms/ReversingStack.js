...
// Steps array simulating recursive calls for reversing the stack
const steps = [
    {
        stack: [1, 2, 3],
        action: "Pop the top element (3) and call reverse recursively.",
        top: 3,
    },
    {
        stack: [1, 2],
        action: "Pop the top element (2) and call reverse recursively.",
        top: 2,
    },
    {
        stack: [1],
        action: "Pop the top element (1) and call reverse recursively.",
        top: 1,
    },
    {
        stack: [],
        action: "Stack is empty, start pushing elements at the bottom.",
        top: null,
    },
    {
        stack: [1],
        action: "Push 1 at the bottom.",
        top: 1,
    },
    {
        stack: [2, 1],
        action: "Push 2 at the bottom.",
        top: 2,
    },
    {
        stack: [3, 2, 1],
        action: "Push 3 at the bottom. Reversal complete.",
        top: 3,
    },
];
...
export default function ReverseStackVisualization() {
    ...
    return (
        <div className="w-full max-w-3xl mx-auto border rounded-lg shadow-sm bg-white">
            <div className="p-6 border-b">
                <h2 className="text-lg font-semibold">Reverse Stack Visualization</h2>
